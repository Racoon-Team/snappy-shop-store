const countries = [
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: 'Los Angeles',
        areas: ['Hollywood', 'Venice', 'Downtown', 'Beverly Hills', 'Santa Monica'],
      },
      {
        name: 'Chicago',
        areas: ['The Loop', 'Lincoln Park', 'Hyde Park', 'Wicker Park', 'Gold Coast'],
      },
    ],
  },

  {
    ...
    cities: [
      ...
      {
        name: 'Vancouver',
        areas: ['Kitsilano', 'Richmond', 'Burnaby', 'Surrey', 'North Vancouver'],
      },
      {
        name: 'Montreal',
        areas: ['Downtown', 'Old Montreal', 'Plateau', 'Westmount', 'Outremont'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: 'Brisbane',
        areas: ['CBD', 'South Bank', 'Fortitude Valley', 'West End', 'New Farm'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: 'Bangalore',
        areas: ['MG Road', 'Whitefield', 'Koramangala', 'Indiranagar', 'Jayanagar'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: 'Rio de Janeiro',
        areas: ['Copacabana', 'Ipanema', 'Leblon', 'Barra da Tijuca', 'Botafogo'],
      },
      {
        name: 'Brasília',
  ...
  },
  {
    ...
    cities: [
      ...
      {
        name: 'Cape Town',
        areas: ['City Bowl', 'Sea Point', 'Green Point', 'Camps Bay', 'Woodstock'],
      },
      {
        name: 'Durban',
  ...
  },
  {
    ...
    cities: [
      {
        name: 'Moscow',
        areas: ['Arbat', 'Tverskoy', 'Zamoskvorechye', 'Basmanny', 'Khamovniki'],
      },
      {
        name: 'Saint Petersburg',
        areas: ['Admiralteysky', 'Vasileostrovsky', 'Petrogradsky', 'Nevsky', 'Kalininsky'],
      },
      {
        name: 'Novosibirsk',
        areas: ['Leninsky', 'Kirovsky', 'Oktyabrsky', 'Zayeltsovsky', 'Sovetsky'],
      },
    ],
  },
  {
    ...
    cities: [
      {
        name: 'Paris',
        areas: ['Le Marais', 'Latin Quarter', 'Montmartre', 'Saint-Germain', 'Belleville'],
      },
      {
        name: 'Lyon',
        areas: ["Presqu'île", 'Croix-Rousse', 'Fourvière', 'Part-Dieu', 'Confluence'],
      },
      {
        name: 'Marseille',
        areas: ['Vieux Port', 'La Corniche', 'Le Panier', 'La Plaine', 'La Joliette'],
      },
    ],
  },
  {
    ...
    cities: [
      {
        name: 'Rome',
        areas: ['Centro Storico', 'Trastevere', 'Monti', 'Testaccio', 'Esquilino'],
      },
      {
        name: 'Milan',
