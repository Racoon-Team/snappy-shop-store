    ...
    <>
      {or && (
        <div className="my-4 text-center font-medium">
          <div className="after:bg-gray-100 before:bg-gray-100">{t('loginScreen.or')}</div>
        </div>
      )}
        ...
        <div className="flex flex-col mb-4">
          {storeSetting?.google_login_status && (
            ...
            >
              ...
              <span className="ml-2">
                {loginTitle} {t('loginScreen.loginGoogle')}
              </span>
            </button>
          )}
          {storeSetting?.facebook_login_status && (
            ...
            >
              ...
              <span className="ml-2">
                {loginTitle} {t('loginScreen.loginFacebook')}
              </span>
            </button>
          )}
          {storeSetting?.github_login_status && (
            ...
            >
              ...
              <span className="ml-2">
                {loginTitle} {t('loginScreen.loginGithub')}
              </span>
            </button>
          )}
        </div>
      ...
      <div className="text-center text-sm text-gray-900 mt-4">
        <div className="text-gray-500 mt-2.5">
          {desc ? t('signupScreen.textAlreadyHaveAccount') : t('loginScreen.textDontHaveAccount')}
          <Link href={route} className="text-gray-800 hover:text-cyan-500 font-bold mx-2">
