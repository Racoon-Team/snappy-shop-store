      ...
      {ctaCardData.map((item) => (
        ...
        >
          <Link href={item.url} className="block">
            <Image width={550} height={234} src={item.image} alt={item.title} priority className="object-cover" />
            <div className="absolute top-0 left-0 z-10 p-r-16 flex-col flex w-full text-center justify-center">
              <div className="pt-4">
                ...
                <p className="text-sm font-sans text-gray-50">{t('homeScreen.week')}</p>
